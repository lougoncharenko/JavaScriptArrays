const inventors = [
  ...
  let fifteen=inventors.filter(function(e) {
  ...
  let firstAndLast=inventors.map(function(e){
  ...
  let yearsLived= inventors.reduce(function(total, inventor){
